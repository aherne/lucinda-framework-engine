...
use Lucinda\Framework\OAuth2\Yandex\SecurityDriver;
use Lucinda\OAuth2\Client\Information;
use Lucinda\OAuth2\Vendor\Yandex\Driver;
...
class SecurityDriverTest
{
    ...
    public function getAuthorizationCode()
    {
        ...
        return $strings->assertContains("https://oauth.yandex.com/authorize");
    }
    ...
    {
        return new Result($this->driver->getVendorName() === "Yandex");
    }
}


//["id"=>1, "first_name"=>"John", "last_name"=>"Doe", "default_email"=>"a@a.com"]
