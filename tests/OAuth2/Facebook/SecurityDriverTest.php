...
use Lucinda\Framework\OAuth2\Facebook\SecurityDriver;
...
class SecurityDriverTest
{
    ...
    public function getAuthorizationCode()
    {
        ...
        return $strings->assertContains("https://www.facebook.com/v2.8/dialog/oauth");
    }
    ...
    {
        return new Result($this->driver->getVendorName() === "Facebook");
    }
}
